    ...
    return(
        ...
        <h5 className="text-accent text-center xs:px-10">+2 years of experience</h5>
            ...
            <div className="px-5 mt-5 xl:w-[90%] mx-auto xs:w-full md:w-full">
                <Tabs defaultValue='education' className='gap-[60px] p-5'>
        ...
        <div className='flex flex-col gap-[30px] text-center xl:text-left'>
          ...
          <li
          key={index}
          className={`bg-[#232329]  text-[17px] h-[80px] w-full px-8 rounded-xl flex items-center justify-center xl:justify-start gap-4 ${
          index >= 0 ? "mt-6" : ""
          }
