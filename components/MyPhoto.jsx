        ...
        <div className="h-full w-full relative">
            <motion.div initial={{opacity:0}} animate={{opacity:1, transition :{delay:2, duration:0.4, ease:"easeInOut"
                ...
                initial={{opacity:0}} animate={{opacity:1, transition :{delay:2.4, duration:0.4, ease:"easeInOut"
                 ...
                 className=" xs:h-[400px] xs:w-[370px] sm:w-[420px]  sm:h-[420px] md:w-[498px] md:h-[450px] lg:w-[450px]  lg:h-[498px] xl:w-[498px] xl:h-[498px] xs:ml-9 xs:mt-12 sm:ml-8 sm:mt-8 md:ml-1 md:mt-5 xl:ml-9 xl:mt-6 my-photo absolute">
